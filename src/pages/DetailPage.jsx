    ...
    <div className=''>
      ...
      >
        <div className="lg:-mt-36 mx-auto lg:mx-0 w-fit relative">
          ...
          />
            <button onClick={()=>handlePlayVideo(data)} className='mt-3 px-4 py-2 bg-white text-black font-bold text-lg w-full rounded-lg hover:bg-gradient-to-l from-red-400 to-orange-400 hover:text-white hover:scale-105 duration-300'>Play Now</button>
        </div>
        ...
        <div className="">
          ...
          <HorizontalScroll data={recommendationsData} heading={"recommendations "+params?.explore} media_type={params?.explore}/>
        </div>
